...
cfg.weapons = {
  ["melees"] = {
    _config = {map_entity = {"PoI", {blip_id=110, blip_color=75, marker_id = 1}}, permissions = {"ammu1.shop"}},
    ["WEAPON_BOTTLE"] = {"Bottle",10000,0,"ARMA NLV1"},
    ["WEAPON_BAT"] = {"Bat",15000,0,"ARMA NLV1"},
    ["WEAPON_KNUCKLE"] = {"Knuckle",15000,0,"ARMA NLV1"},
    ["WEAPON_KNIFE"] = {"Knife",20000,0,"ARMA NLV1"},
    ["ARMOR"] = {"Body Armor",10000,0,"ARMA NLV1"}
  },

  ["sidearms"] = {
    _config = {map_entity = {"PoI", {blip_id=110, blip_color=75, marker_id = 1}}, permissions = {"ammu1.shop"}},
    ["WEAPON_MARKSMANPISTOL"] = {"Marksman Pistol",15000,15,"ARMA NLV1"},
    ["WEAPON_SNSPISTOL"] = {"SNS Pistol",25000,15,"ARMA NLV1"},
    ["WEAPON_VINTAGEPISTOL"] = {"Vintage Pistol",25000,15,"ARMA NLV1"},
    ["WEAPON_PISTOL"] = {"Pistol",25000,15,"ARMA NLV1"},
    ["WEAPON_COMBATPISTOL"] = {"Combat Pistol",50000,15,"ARMA NLV1"},
    ["WEAPON_HEAVYPISTOL"] = {"Heavy Pistol",50000,15,"ARMA NLV1"},
    ["WEAPON_REVOLVER"] = {"Heavy Revolver",50000,15,"ARMA NLV1"},
    ["WEAPON_APPISTOL"] = {"Ap Pistol",75000,15,"ARMA NLV1"},
    ["WEAPON_DAGGER"] = {"Dagger",20000,0,"ARMA NLV1"},
    ["WEAPON_HAMMER"] = {"Hammer",25000,0,"ARMA NLV1"},
    ["WEAPON_HATCHET"] = {"Hatchet",30000,0,"ARMA NLV1"},
    ["ARMOR"] = {"Body Armor",10000,0,"Antibalas"}
  },
